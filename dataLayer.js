var dataLayer = (function() {
    ...
    var _private = {
             ...
             * @param {string} [privacyType=default] - Used to check tools against white list
             * @param {string} [layerID=global] - If multiple data layers exist on the page
            ...
            "publish": function(dataID, dataValue, privacyType, layerID) {
                ...
                if (!_private.layer[layerID]) {
                    ...
                    _private.currentState[layerID] = 0;
                }
            ...
            "subscribe": function(dataID, toolDomain, toolMethod, previousPubs, layerID, chain) {
                ...
                //If there is not a dataID or toolMethod is omitted, we cannot publish, so escape.
                ...
                for (var i = 0; i < _private.subscriptions[layerID][dataID].length; i++) {
                    if(!!_private.subscriptions[layerID][dataID][i][toolDomain]){
                        return false;
                    }
                }
            ...
            /** 
             * Delete Specific dataLayer value
             * @private
             * @param {string} dataID - Data of Interest
             * @param {string} toolDomain - Tool domain for privacy purposes
             * @param {string} [layerID=global] - If multiple data layers exist on the page
     ...
     */
        _public = {
             ...
             */
            "delVal": function(dataID, toolDomain, layerID) {
                return _private.delVal(dataID, toolDomain, layerID);
            },
            /**
             * Allows various analytics tools to listen for old & future dataLayer changes
